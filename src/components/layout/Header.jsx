...
function Header() {
  ...
  const wishlistProducts = PRODUCTS.slice(2, 4)
      ...
      <div className="ds-header__body">
        <div className="ds-header__main container">
          ...
          <div className="ds-header__actions">
            ...
            >
              <IconCart />
              <span className="ds-cart-badge">2</span>
            </button>
          </div>
        </div>
          ...
          <div className="ds-panel__inner container">
              ...
              <div className="ds-search-panel">
                ...
                <div className="ds-panel-products">
                  {searchResults.map(product => (
                    <Link to="/shop" className="ds-panel-product" key={product.id} onClick={closePanel}>
            ...
            {activePanel === 'wishlist' && (
              <div className="ds-mini-panel">
                ...
                <Link to="/shop" className="ds-panel-cta" onClick={closePanel}>View Wishlist</Link>
              </div>
            )}
            ...
            {activePanel === 'account' && (
              <div className="ds-mini-panel">
                <h3>Account</h3>
                <p>Sign in to manage orders, wishlist items, and saved addresses.</p>
            ...
            {activePanel === 'cart' && (
              <div className="ds-mini-panel">
                ...
                <Link to="/shop" className="ds-panel-cta" onClick={closePanel}>Checkout</Link>
              </div>
            )}
          </div>
        </div>
